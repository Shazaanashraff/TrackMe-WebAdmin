    ...
    <Box sx={{ display: 'flex', minHeight: '100vh', backgroundColor: '#f8f9fa' }}>
      ...
      >
        ...
        <List sx={{ px: 2, flexGrow: 1 }}>
          ...
          <Typography variant="caption" sx={{ px: 2, mt: 3, mb: 1.5, display: 'block', color: '#2f2f2f', fontWeight: 800, textTransform: 'uppercase', fontSize: '0.65rem', opacity: 0.6 }}>
            Account Pages
          </Typography>
      ...
      >
        ...
        <Box sx={{
          ...
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
            ...
            <Avatar sx={{ width: 32, height: 32, ml: 1, backgroundColor: '#2f2f2f', fontSize: 12, fontWeight: 800 }}>
